...
#Yishan add params : update_client_secret
class AuthorizationServer(object):
    ...
    """
    def __init__(self, query_client, save_token, generate_token=None, metadata=None,update_client_secret=None):
        self.query_client = query_client
        self.save_token = save_token
        self.generate_token = generate_token
        self.update_client_secret = update_client_secret
    ...
    def authenticate_client(self, request, methods,isupdate=False):
        ...
        if self._client_auth is None and self.query_client:
            ...
            #print self.query_client.__dict__
            self._client_auth = ClientAuthentication(self.query_client)
            #print "dddddddddddddddddd"
            #print self._client_auth
        return self._client_auth(request, methods,isupdate)
    ...
    def get_token_grant(self, request):
        ...
        for (grant_cls, extensions) in self._token_grants:
            ...
            #print "~~~~extensions~~~~"
            #print extensions
            #print "~~~~grant_cls.check_token_endpoint(request)~~~~"
            #print grant_cls.check_token_endpoint(request)
    ...
    #Yishan add
    def update_client_secret_func(self, request=None):
