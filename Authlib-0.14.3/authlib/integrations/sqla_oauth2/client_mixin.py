...
class OAuth2ClientMixin(ClientMixin):
    ...
    client_secret_update_times = Column(Integer, nullable=False, default=0)
    ...
    def client_info(self):
        ...
        return dict(
            ...
            client_secret_update_times=self.client_secret_update_times
        )
    ...
    def get_expires_at(self):
        return self.client_id_issued_at + self.client_secret_expires_at
